...
| [06 - HA y escalabilidad](./06-ha-scalability/) | Escalado vertical y horizontal, alta disponibilidad frente a DR, Elastic Load Balancing, tipos de load balancer, ALB: target groups y reglas de enrutamiento *(en curso)* |
