...
| [07 - CloudFormation](./07-cloudformation/) | Infraestructura como código, ventajas, funcionamiento con S3 y stacks, despliegue manual y automatizado, componentes de una plantilla, prácticas de Create, Update y Delete Stack con parámetros, tags y change sets, Resources, Parameters, pseudo parámetros, Mappings, Outputs con exports cross-stack y Conditions *(en curso)* |
